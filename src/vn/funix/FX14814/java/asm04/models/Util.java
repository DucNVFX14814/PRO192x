...
public class Util {
	...
	public static final String ROOT_PATH = "src/vn/funix/FX14814/java/asm04/";
	public static final String DEFAULT_FOLDER = "store/";

	public static String getFilePath(String relativePath) {
//    	String filePath = ASM04.class.getProtectionDomain().getCodeSource().getLocation() + relativePath;
		String filePath = ROOT_PATH;
		if (!relativePath.startsWith(DEFAULT_FOLDER)) {
			filePath = filePath + DEFAULT_FOLDER;
		}
